...
class OrderStepDef {
	...
	def I_enter_the_email_and_password(String email, String password) {
		WebUI.setText(findTestObject('Object Repository/TC Order/Page_frontend-web/input_Email_input-102'), email)
		WebUI.setText(findTestObject('Object Repository/TC Order/Page_frontend-web/input_Password_input-105'), password)
	}
